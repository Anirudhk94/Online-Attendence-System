	...
	<li><a  href="#">Show Attendance </a></li></ul>
	  ...
	  <!-- side bar ends here  -->
			<div class="inner">
				...
				<form name="addEmp" method="post" action="AddUserController"
					...
					<table align='center' cellspacing='0'>
						...
						<TR>
							<TD>Phone number</TD>
							<TD><INPUT TYPE="text" NAME="phoneNumber" maxlength="10" /></TD>
						</TR>

						<TR>
							<TD>Designation</TD>
							<!-- add select list admin,project team,it team-->
							<TD><select name="role">
						...
						<TR>
							<td><input type="submit" name="enter_button" value="Add" /></td>
