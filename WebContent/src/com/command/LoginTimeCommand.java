...
public class LoginTimeCommand implements Command{
  ...
  public void execute(HttpServletRequest request,
      ...
      mapToEmployeeBean (request, employeeBean);
        ...
        if ("success".equalsIgnoreCase(this.markInTime(employeeBean))){
    ...
    private String markInTime(EmployeeBean empBean){
    	
    	EmployeeDAO dao = new EmployeeDAO(); 
    	return dao.markInTime(empBean);    	
    }
}
