...
<%@page import="com.shreshta.oas.dao.AttendanceDao"%>
...
function goBack(){
	...
	<div class="main">
		...
		<div class="header menu">
			...
			<a href="facultyHome.jsp" onclick="return goBack()">Home</a> | <a href="logout.jsp">Logout</a>
			...
			<div class="inner">
				...
				<form name="addEmp" method="post" onsubmit="return validate()">
					...
					if(userBean.getRole().equals("admin")){
						studentAttendanceList = attDao.getStdAttendanceList(null);
					%>
					<tr>
					<th>Faculty</th>
					<th>Student</th>
					...
					<%for(AttendanceBean studentAttendance : studentAttendanceList){%>
						<tr>
							<td><%=studentAttendance.getFaculty() %></td>
							<td><%=studentAttendance.getStudent() %></td>
							<td><%=studentAttendance.getStatus() %></td>
						</tr>
					<%}%>
					<%}
					else{
						studentAttendanceList = attDao.getStdAttendanceList(userBean);
						%>
						<tr>
						<th>Student</th>
						<th>Attendance</th>
